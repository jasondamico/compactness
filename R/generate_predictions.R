...
generate_predictions = function(features, namecol, idcol = NULL, new.models = NULL){
  ...
  if(is.null(idcol)) {
    ...
    preds3 = data.frame(district = features[,namecol], state_id = features[,idcol], compactness = preds2)
  }
